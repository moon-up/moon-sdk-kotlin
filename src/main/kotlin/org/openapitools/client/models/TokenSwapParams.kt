...
data class TokenSwapParams (

    @Json(name = "tokenIn")
    val tokenIn: kotlin.String,

    @Json(name = "tokenOut")
    val tokenOut: kotlin.String,

    @Json(name = "tokenInDecimals")
    val tokenInDecimals: kotlin.Double,

    @Json(name = "tokenOutDecimals")
    val tokenOutDecimals: kotlin.Double,

    @Json(name = "amountIn")
    val amountIn: kotlin.String,

    @Json(name = "slippage")
    val slippage: kotlin.String,
