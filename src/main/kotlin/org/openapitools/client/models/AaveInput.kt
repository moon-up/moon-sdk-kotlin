 ...
 * @param lendingPool 
 * @param amount 
 * @param atokenToRedeeem 
 * @param refCode 
 * @param interestRateMode 
 */


data class AaveInput (
    ...
    @Json(name = "lending_pool")
    val lendingPool: kotlin.String? = null,

    @Json(name = "amount")
    val amount: kotlin.String? = null,

    @Json(name = "atoken_to_redeeem")
    val atokenToRedeeem: kotlin.String? = null,

    @Json(name = "ref_code")
    val refCode: kotlin.String? = null,

    @Json(name = "interest_rate_mode")
    val interestRateMode: kotlin.String? = null
